...
analogtv_alloc_image(analogtv *it)
{
  ...
  if (!it->image) {
#if 1
    it->image = XCreateImage(it->dpy, it->xgwa.visual, it->xgwa.depth, RGBAPixmap_, 0, 0,
...
#if 1
  gcv.background=load_color(it->dpy, it->colormap, background);
#else
