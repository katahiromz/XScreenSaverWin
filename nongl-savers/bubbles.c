...
static argtype vars[] = 
{
    ...
    {&simple, "simple", NULL, "False", t_Bool},
    {&broken, "broken", NULL, "False", t_Bool},
    {&delay, "delay", NULL, "10000", t_Int},
    {&quiet, "quiet", NULL, "False", t_Bool},
    {&mode, "mode", NULL, "float", t_String},
    {&trails, "trails", NULL, "False", t_Bool},
    {&_3D, "3D", NULL, "False", t_Bool},
};
...
#if 1
  st->default_fg_pixel = load_color(st->dpy, cmap, foreground);
  st->default_bg_pixel = load_color(st->dpy, cmap, background);
#else
