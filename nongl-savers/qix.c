...
static argtype vars[] = 
{
    ...
    {&count, "count", NULL, "4", t_Int},
    {&segments, "segments", NULL, "250", t_Int},
    {&poly, "poly", NULL, "2", t_Int},
    {&spread, "spread", NULL, "8", t_Int},
    {&size, "size", NULL, "200", t_Int},
    {&colorShift, "colorShift", NULL, "3", t_Int},
    {&solid, "solid", NULL, "True", t_Bool},
    {&delay, "delay", NULL, "10000", t_Int},
    {&random, "random", NULL, "False", t_Bool},
    {&xor, "xor", NULL, "False", t_Bool},
    {&transparent, "transparent", NULL, "True", t_Bool},
    {&gravity, "gravity", NULL, "False", t_Bool},
    {&additive, "additive", NULL, "True", t_Bool},
};
