...
static argtype vars[] = 
{
    ...
    {&speed, "speed", NULL, "0", t_Int},
    {&number, "number", NULL, "0", t_Int},
    {&slow, "slow", NULL, "False", t_Bool},
    {&vortex, "vortex", NULL, "False", t_Bool},
    {&magnify, "magnify", NULL, "False", t_Bool},
...
#if 1
			&& (st->buffer_map->format == RGBAPixmap_)
			&& (st->orig_map->format == RGBAPixmap_)
#else
