...
static argtype vars[] = 
{
    ...
    {&points, "points", NULL, "200", t_Int},
    {&steps_, "steps", NULL, "150", t_Int},
    {&delay, "delay", NULL, "70000", t_Int},
    {&figtype, "figtype", NULL, "all", t_String},
    {&linewidth, "linewidth", NULL, "5", t_Int},
};
