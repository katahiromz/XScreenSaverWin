...
static argtype vars[] = 
{
    ...
    {&background, "background", NULL, "#111111", t_String},
    {&lenses, "lenses", NULL, "True", t_Bool},
    {&delay, "delay", NULL, "10000", t_Int},
    {&duration, "duration", NULL, "120", t_Int},
    {&pixwidth, "pixwidth", NULL, "10", t_Int},
    {&pixheight, "pixheight", NULL, "10", t_Int},
    {&pixspacex, "pixspacex", NULL, "2", t_Int},
