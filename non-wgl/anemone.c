...
static argtype vars[] = 
{
    ...
    {&arms, "arms", NULL, "128", t_Int},
    {&width, "width", NULL, "2", t_Int},
    {&finpoints, "finpoints", NULL, "64", t_Int},
    {&delay, "delay", NULL, "40000", t_Int},
    {&withdraw, "withdraw", NULL, "1200", t_Int},
    {&turnspeed, "turnspeed", NULL, "50.0", t_Float},
    {&colors, "colors", NULL, "20", t_Int},
};
...
anemone_init (Display *disp, Window window)
{
  ...
  st->width = width;
  st->arms = arms;
  st->finpoints = finpoints;
  st->delay = delay;
  st->withdraw = withdraw;
  st->turndelta = turnspeed;
#else
...
# endif
  ...
  st->gcv.foreground = load_color(st->dpy, st->cmap, background);
