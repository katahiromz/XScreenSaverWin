...
static argtype vars[] = 
{
    ...
    {&bgrowth, "bgrowth", NULL, "5", t_Int},
    {&lrate, "lrate", NULL, "80", t_Int},
    {&smart, "smart", NULL, "False", t_Bool},
};

void usleep(unsigned long ul)
{
	Sleep(ul / 1000);
}
...
penetrate_init (Display *dpy, Window window)
{
  ...
  const char *levelfont = "Courier 28";
  const char *scorefont = "MS Serif 28";
  XGCValues gcv;
