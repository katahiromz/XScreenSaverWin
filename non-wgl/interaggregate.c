...
static argtype vars[] = 
{
    ...
    {&percentOrbits, "percentOrbits", NULL, "0", t_Int},
    {&baseOrbits, "baseOrbits", NULL, "75", t_Int},
    {&baseOnCenter, "baseOnCenter", NULL, "False", t_Bool},
    {&drawCenters, "drawCenters", NULL, "False", t_Bool},
};
...
interaggregate_init (Display *dpy, Window window)
{
    ...
    st->f->percent_orbits = percentOrbits;
    st->f->base_orbits = baseOrbits;
    st->f->base_on_center = baseOnCenter;
    st->f->draw_centers = drawCenters;
#else
