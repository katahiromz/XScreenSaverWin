...
char *fadeForeground = "#006400";
char *flareForeground = "#FFFFFF";
char *font = "(builtin)";
int scale = 6;
int ticks = 20;
int delay = 50000;
...
static argtype vars[] = 
{
    ...
    {&fadeForeground, "fadeForeground", NULL, "#006400", t_String},
    {&flareForeground, "flareForeground", NULL, "#FFFFFF", t_String},
    {&font, "font", NULL, "(builtin)", t_String},
    {&scale, "scale", NULL, "6", t_Int},
    {&ticks, "ticks", NULL, "20", t_Int},
    {&delay, "delay", NULL, "50000", t_Int},
    {&program, "textProgram", NULL, "xscreensaver-text", t_String},
    {&relaunchDelay, "relaunchDelay", NULL, "6", t_Int},
    {&scale, "scale", NULL, "6", t_Int},
...
static void set_cursor (p_state *state, Bool on)
{
}
...
#if 1
    unsigned long fg = load_color(state->dpy, state->xgwa.colormap, foreground);
    unsigned long bg = load_color(state->dpy, state->xgwa.colormap, background);
    unsigned long flare = load_color(state->dpy,state->xgwa.colormap,flareForeground);
    unsigned long fade = load_color(state->dpy,state->xgwa.colormap,fadeForeground);
#else
