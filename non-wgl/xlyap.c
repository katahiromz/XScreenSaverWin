...
float minB = 2.0;
int wheels = 7;
char *function = "10101010";
char *forcingFunction = "abbabaab";
char *bRange = "";
float startX = 0.65;
char *mapIndex = "";
char *outputFile = "";
...
static argtype vars[] = 
{
    ...
    {&randomize, "randomize", NULL, "True", t_Bool},
    {&builtin_, "builtin", NULL, "-1", t_String},
    {&dwell, "dwell", NULL, "50", t_Int},
    {&randomForce, "randomForce", NULL, "", t_String},
    {&settle, "settle", NULL, "50", t_Int},
    {&minA, "minA", NULL, "2.0", t_Float},
    {&minB, "minB", NULL, "2.0", t_Float},
    {&wheels, "wheels", NULL, "7", t_Int},
    {&function, "function", NULL, "10101010", t_String},
    {&forcingFunction, "forcingFunction", NULL, "abbabaab", t_String},
    {&bRange, "bRange", NULL, "", t_String},
    {&startX, "startX", NULL, "0.65", t_Float},
    {&mapIndex, "mapIndex", NULL, "", t_String},
    {&outputFile, "outputFile", NULL, "", t_String},
    {&beNegative, "beNegative", NULL, "False", t_Bool},
    {&spinLength, "spinLength", NULL, "256", t_Int},
    {&show, "show", NULL, "False", t_Bool},
    {&aRange, "aRange", NULL, "", t_String},
    {&delay, "delay", NULL, "10000", t_Int},
    {&linger, "linger", NULL, "5", t_Int},
};
