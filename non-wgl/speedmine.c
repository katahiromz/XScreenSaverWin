...
char *darkground = "#101010";
char *lightground = "#a0a0a0";
char *tunnelend = "#000000";
int delay = 30000;
int maxspeed = 700;
float thrust = 1.0;
float gravity = 9.8;
...
static argtype vars[] = 
{
    {&verbose, "verbose", NULL, "False", t_Bool},
    {&worm, "worm", NULL, "False", t_Bool},
    {&wire, "wire", NULL, "False", t_Bool},
    {&background, "background", NULL, "black", t_String},
    {&foreground, "foreground", NULL, "white", t_String},
    {&darkground, "darkground", NULL, "#101010", t_String},
    {&lightground, "lightground", NULL, "#a0a0a0", t_String},
    {&tunnelend, "tunnelend", NULL, "#000000", t_String},
    {&delay, "delay", NULL, "30000", t_Int},
    {&maxspeed, "maxspeed", NULL, "700", t_Int},
    {&thrust, "thrust", NULL, "1.0", t_Float},
    {&gravity, "gravity", NULL, "9.8", t_Float},
    {&vertigo, "vertigo", NULL, "1.0", t_Float},
    {&terrain, "terrain", NULL, "True", t_Bool},
    {&smoothness, "smoothness", NULL, "6", t_Int},
    {&curviness, "curviness", NULL, "1.0", t_Float},
    {&twistiness, "twistiness", NULL, "1.0", t_Float},
    {&widening, "widening", NULL, "True", t_Bool},
    {&bumps, "bumps", NULL, "True", t_Bool},
    {&bonuses, "bonuses", NULL, "True", t_Bool},
    {&crosshair, "crosshair", NULL, "True", t_Bool},
    {&psychedelic, "psychedelic", NULL, "False", t_Bool},
};
...
init_psychedelic_colors (struct state *st)
{
  ...
  gcv.foreground = load_color(st->dpy, st->cmap, tunnelend);
...
# ifdef HAVE_COCOA	/* Don't second-guess Quartz's double-buffering */
  ...
  gcv.foreground = st->default_fg_pixel = load_color(st->dpy, st->cmap, foreground);
  ...
  gcv.foreground = load_color(st->dpy, st->cmap, background);
  ...
  st->psychedelic_flag = psychedelic;
  ...
  st->curviness = curviness;
  st->curviness *= 0.25;

  //st->twistiness = get_float_resource(st->dpy, "twistiness", "Float");
  st->twistiness = twistiness;
  st->twistiness *= 0.125;

#if 1
  st->terrain_flag = terrain;
  st->widening_flag = widening;
  st->bumps_flag = bumps;
  st->bonuses_flag = bonuses;
  st->crosshair_flag = crosshair;
  st->be_wormy = worm;
#else
