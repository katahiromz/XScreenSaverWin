...
static argtype vars[] = 
{
    ...
    {&iterations, "iterations", NULL, "25", t_Int},
    {&delay, "delay", NULL, "50000", t_Int},
    {&delay2, "delay2", NULL, "2000000", t_Int},
    {&points, "points", NULL, "10000", t_Int},
};
...
flame_init (Display *dpy, Window window)
{
  ...
  gcv.background = load_color(st->dpy, cmap, background);
