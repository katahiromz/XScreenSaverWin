...
char *foreground = "#BEBEBE";
int gridSize = 70;
int pixelIncrement = 10;
int internalBorderWidth = 4;
int delay = 50000;
int delay2 = 1000000;
int duration = 120;
...
static argtype vars[] = 
{
    ...
    {&foreground, "foreground", NULL, "#BEBEBE", t_String},
    {&gridSize, "gridSize", NULL, "70", t_Int},
    {&pixelIncrement, "pixelIncrement", NULL, "10", t_Int},
    {&internalBorderWidth, "internalBorderWidth", NULL, "4", t_Int},
...
slidescreen_init (Display *dpy, Window window)
{
  ...
  st->grid_size = gridSize;
  st->pix_inc = pixelIncrement;
#else
...

  {
    ...
    //char *bgs = get_string_resource(st->dpy, "foreground", "Foreground");
  	char *fgs = _strdup(background);
    char *bgs = _strdup(foreground);
    Bool fg_ok, bg_ok;
