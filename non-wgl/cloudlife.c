...
static argtype vars[] = 
{
    ...
    {&cycleDelay, "cycleDelay", NULL, "25000", t_Int},
    {&cycleColors, "cycleColors", NULL, "2", t_Int},
    {&ncolors, "ncolors", NULL, "64", t_Int},
    {&maxAge, "maxAge", NULL, "64", t_Int},
    {&initialDensity, "initialDensity", NULL, "30", t_Int},
    {&cellSize, "cellSize", NULL, "3", t_Int},
};
...
cloudlife_init (Display *dpy, Window window)
{
  struct state *st = (struct state *) calloc (1, sizeof(*st));
    ...
    st->density = (get_integer_resource(st->dpy, "initialDensity", "Integer") 
                  % 100 * 256)/100;
#else
    st->cycle_delay = cycleDelay;
    st->cycle_colors = cycleColors;
    st->ncolors = ncolors;
    st->density = (initialDensity % 100 * 256)/100;
#endif
