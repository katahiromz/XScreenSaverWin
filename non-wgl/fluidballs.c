...
float gravity = 0.01;
float wind = 0.00;
float elasticity = 0.97;
float timeScale = 1.0;
Bool shake_p = True;
float shakeThreshold = 0.015;
Bool doubleBuffer = True;
Bool useDBE = True;
Bool useDBEClear = True;

static argtype vars[] = 
{
    {&background, "background", NULL, "black", t_String},
    {&foreground, "foreground", NULL, "yellow", t_String},
    {&textColor, "textColor", NULL, "white", t_String},
    {&mouseForeground, "mouseForeground", NULL, "white", t_String},
    {&delay, "delay", NULL, "10000", t_Int},
    {&count, "count", NULL, "300", t_Int},
    {&size, "size", NULL, "25", t_Int},
    {&random, "random", NULL, "True", t_Bool},
    {&gravity, "gravity", NULL, "0.01", t_Float},
    {&wind, "wind", NULL, "0.00", t_Float},
    {&elasticity, "elasticity", NULL, "0.97", t_Float},
    {&timeScale, "timeScale", NULL, "1.0", t_Float},
    {&shake_p, "shake", NULL, "True", t_Bool},
    {&shakeThreshold, "shakeThreshold", NULL, "0.015", t_Float},
    {&doubleBuffer, "doubleBuffer", NULL, "True", t_Bool},
    {&useDBE, "useDBE", NULL, "True", t_Bool},
    {&useDBEClear, "useDBEClear", NULL, "True", t_Bool},
};
...
# endif
...
#if 1
  gcv.foreground = load_color(state->dpy, state->xgwa.colormap, foreground);
  gcv.background = load_color(state->dpy, state->xgwa.colormap, background);
#else
  ...
  gcv.foreground = load_color(state->dpy, state->xgwa.colormap, mouseForeground);
