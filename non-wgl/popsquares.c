...
char *background = "#0000FF";
char *foreground = "#00008B";
int delay = 25000;
int subdivision = 5;
int border = 1;
int ncolors = 128;
...
static argtype vars[] = 
{
    {&background, "background", NULL, "#0000FF", t_String},
    {&foreground, "foreground", NULL, "#00008B", t_String},
    {&delay, "delay", NULL, "25000", t_Int},
    {&subdivision, "subdivision", NULL, "5", t_Int},
    {&border, "border", NULL, "1", t_Int},
    {&ncolors, "ncolors", NULL, "128", t_Int},
    {&twitch, "twitch", NULL, "False", t_Bool},
...
#if 1
  fg.pixel = load_color(st->dpy, st->xgwa.colormap, foreground);
  bg.pixel = load_color(st->dpy, st->xgwa.colormap, background);
#else
