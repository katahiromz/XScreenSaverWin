...
static argtype vars[] = 
{
    ...
    {&colorMode, "colorMode", NULL, "random", t_String},
    {&colors, "colors", NULL, "100", t_Int},
    {&count, "count", NULL, "0", t_Int},
    {&delay, "delay", NULL, "100000", t_Int},
    {&delay2, "delay2", NULL, "20", t_Int},
    {&increment, "increment", NULL, "0", t_Int},
    {&animate, "animate", NULL, "False", t_Bool},
};
...
halo_init (Display *dpy, Window window)
{
  ...
  if (mono_p)
    {
#if 1
      st->fg_pixel = load_color(st->dpy, st->cmap, foreground);
      st->bg_pixel = load_color(st->dpy, st->cmap, background);
#else
