...
static argtype vars[] = 
{
    ...
    {&maxDepth, "maxDepth", NULL, "12", t_Int},
    {&minWidth, "minWidth", NULL, "20", t_Int},
    {&minHeight, "minHeight", NULL, "20", t_Int},
    {&lineWidth, "lineWidth", NULL, "1", t_Int},
    {&delay, "delay", NULL, "5", t_Int},
    {&ncolors, "ncolors", NULL, "64", t_Int},
    {&goldenRatio, "goldenRatio", NULL, "False", t_Bool},
    {&smoothColors, "smoothColors", NULL, "False", t_Bool},
    {&mondrian, "mondrian", NULL, "False", t_Bool},
};
