...
static argtype vars[] = 
{
    ...
    {&mismunch, "mismunch", NULL, "random", t_String},
    {&simul, "simul", NULL, "5", t_Int},
    {&clear, "clear", NULL, "65", t_Int},
    {&xor_, "speed", NULL, "True", t_Bool},
};
...
munch_init (Display *dpy, Window w)
{
  ...
  gcv.background= load_color(st->dpy, xgwa.colormap, background);
#else
