...
Bool angles = True;
Bool scroll = False;
int scroll_overlap = 400;
int anim_delay = 100;
int anim_step_size = 3;
Bool randomize = True;
...
static argtype vars[] = 
{
    ...
    {&minWidth, "minWidth", NULL, "40", t_Int},
    {&minHeight, "minHeight", NULL, "40", t_Int},
    {&max_Width, "max_Width", NULL, "150", t_Int},
    {&max_Height, "max_Height", NULL, "150", t_Int},
    {&maxLineWidth, "maxLineWidth", NULL, "25", t_Int},
    {&minLineWidth, "minLineWidth", NULL, "2", t_Int},
    {&erase, "erase", NULL, "True", t_Bool},
    {&eraseCount, "eraseCount", NULL, "25", t_Int},
    {&square, "square", NULL, "True", t_Bool},
    {&delay, "delay", NULL, "400000", t_Int},
    {&curves, "curves", NULL, "True", t_Bool},
    {&angles, "angles", NULL, "True", t_Bool},
    {&scroll, "scroll", NULL, "False", t_Bool},
    {&scroll_overlap, "scroll_overlap", NULL, "400", t_Int},
    {&anim_delay, "anim_delay", NULL, "100", t_Int},
    {&anim_step_size, "anim_step_size", NULL, "3", t_Int},
