...
static argtype vars[] = 
{
    ...
    {&colorscheme, "colorscheme", NULL, "smooth", t_String},
    {&delay, "delay", NULL, "10000", t_Int},
    {&ncolors, "ncolors", NULL, "64", t_Int},
    {&restart, "restart", NULL, "8", t_Int},
    {&batchcount, "batchcount", NULL, "1500", t_Int},
    {&trail, "trail", NULL, "50", t_Int},
};
...
critical_init (Display *dpy, Window window)
{
  ...
  st->settings.trail = clip(2, trail, 1000);
  ...
  st->gcv.foreground = load_color(st->dpy, st->wattr.colormap, background);
  ...
  st->delay_usecs = delay;
  st->n_restart = restart;
