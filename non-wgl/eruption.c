...
static argtype vars[] = 
{
    ...
    {&cycles, "cycles", NULL, "80", t_Int},
    {&ncolors, "ncolors", NULL, "256", t_Int},
    {&delay, "delay", NULL, "10000", t_Int},
    {&particles, "particles", NULL, "300", t_Int},
    {&cooloff, "cooloff", NULL, "2", t_Int},
    {&gravity, "gravity", NULL, "1", t_Int},
    {&heat, "heat", NULL, "256", t_Int},
};
