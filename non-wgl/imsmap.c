...
static argtype vars[] = 
{
    {&background, "background", NULL, "#000066", t_String},
    {&foreground, "foreground", NULL, "#FF00FF", t_String},
    {&mode, "mode", NULL, "random", t_String},
    {&ncolors, "ncolors", NULL, "50", t_Int},
    {&iterations, "iterations", NULL, "7", t_Int},
    {&delay, "delay", NULL, "5", t_Int},
    {&delay2, "delay2", NULL, "20000", t_Int},
};
  ...
  if (mono_p)
    {
      int i;
#if 1
      unsigned long fg_pixel = load_color(st->dpy, st->xgwa.colormap, foreground);
      unsigned long bg_pixel = load_color(st->dpy, st->xgwa.colormap, background);
#else
