...
static argtype vars[] = 
{
    ...
    {&degrees, "degrees", NULL, "0", t_Int},
    {&color, "color", NULL, "random", t_String},
    {&count, "count", NULL, "4", t_Int},
    {&cycles, "cycles", NULL, "10", t_Int},
...
shadebobs_init (Display *dpy, Window window)
{
  ...
  st->window = window;
	...
	st->delay = delay;
	st->cycles = cycles * st->iDegreeCount;
