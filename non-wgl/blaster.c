...
char *r_color0 = "#FF00FF";
char *r_color1 = "#FFA500";
char *r_color2 = "#FFFF00";
char *r_color3 = "#FFFFFF";
char *r_color4 = "#0000FF";
char *r_color5 = "#00FFFF";
char *l_color0 = "#00FF00";
char *l_color1 = "#FF0000";
char *mother_ship_color0 = "#00008B";
char *mother_ship_color1 = "#FFFFFF";
char *explode_color_1 = "#FFFF00";
char *explode_color_2 = "#FFA500";
...
int mother_ship_width = 25;
int mother_ship_height = 7;
int mother_ship_laser = 15;
int mother_ship_period = 150;
int mother_ship_hits = 10;
int explode_size_1 = 27;
int explode_size_2 = 19;
int explode_size_3 = 7;
int num_stars = 50;
char *star_color = "white";
Bool move_stars = True;
int move_stars_x = 2;
int move_stars_y = 1;
int move_stars_random = 0;
...
static argtype vars[] = 
{
    ...
    {&num_robots, "num_robots", NULL, "5", t_Int},
    {&num_lasers, "num_lasers", NULL, "3", t_Int},
    {&mother_ship, "mother_ship", NULL, "False", t_Bool},
    {&mother_ship_width, "mother_ship_width", NULL, "25", t_Int},
    {&mother_ship_height, "mother_ship_height", NULL, "7", t_Int},
    {&mother_ship_laser, "mother_ship_laser", NULL, "15", t_Int},
    {&mother_ship_period, "mother_ship_period", NULL, "150", t_Int},
    {&mother_ship_hits, "mother_ship_hits", NULL, "10", t_Int},
    {&explode_size_1, "explode_size_1", NULL, "27", t_Int},
    {&explode_size_2, "explode_size_2", NULL, "19", t_Int},
    {&explode_size_3, "explode_size_3", NULL, "7", t_Int},
    {&num_stars, "num_stars", NULL, "50", t_Int},
    {&star_color, "star_color", NULL, "white", t_String},
    {&move_stars, "move_stars", NULL, "True", t_Bool},
    {&move_stars_x, "move_stars_x", NULL, "2", t_Int},
    {&move_stars_y, "move_stars_y", NULL, "1", t_Int},
    {&move_stars_random, "move_stars_random", NULL, "0", t_Int},
};
...
blaster_init (Display *d, Window w)
{
  ...
  st->EXPLODE_SIZE_3=7;
	...
	st->EXPLODE_SIZE_1 = explode_size_1;
	st->EXPLODE_SIZE_2 = explode_size_2;
	st->EXPLODE_SIZE_3 = explode_size_3;

	//st->NUM_STARS = get_integer_resource(st->dpy, "num_stars","Integer");
	st->NUM_STARS = num_stars;
	...
	if(move_stars)
	{
		...
		st->MOVE_STARS_X = move_stars_x;
		st->MOVE_STARS_Y = move_stars_y;
		st->MOVE_STARS_RANDOM = move_stars_random;
	}
	else {
		st->MOVE_STARS = 0;
	}
	...
	bg = load_color(st->dpy, cmap, background);
	gcv.function = GXcopy;
...
#define make_gc_(color,name) \
	gcv.foreground = load_color(st->dpy, cmap, name); \
	color = XCreateGC (st->dpy, st->window, GCForeground|GCFunction, &gcv);
	...
	if(mono_p) {
		...
		{
#if 1
			st->MOTHER_SHIP_WIDTH=mother_ship_width;
			st->MOTHER_SHIP_HEIGHT=mother_ship_height;
			st->MOTHER_SHIP_LASER=mother_ship_laser;
			st->MOTHER_SHIP_PERIOD=mother_ship_period;
			st->MOTHER_SHIP_HITS=mother_ship_hits;
#else
		...
		if(mother_ship)
		{
			...
			st->mother->active = 0;
			st->mother->death = 0;
			make_gc_(st->mother->ship_color,mother_ship_color0);
			make_gc_(st->mother->laser_color,mother_ship_color1);		
		}
      ...
      make_gc_(st->r_color0,r_color0);
      make_gc_(st->r_color1,r_color1);
      make_gc_(st->r_color2,r_color2);
      make_gc_(st->r_color3,r_color3);
      make_gc_(st->r_color4,r_color4);
      make_gc_(st->r_color5,r_color5);
      make_gc_(st->l_color0,l_color0);
      make_gc_(st->l_color1,l_color1);
#ifdef HAVE_COCOA	/* Don't second-guess Quartz's double-buffering */
    st->black = 0;
#else
		make_gc_(st->black,background);
#endif
	}
