...
char *borderColor = "blue";
int borderWidth = 3;
int delay = 10000;
int duration = 120;
float eventChance = 0.01;
float friction = 0.05;
int maxColumns = 0;
int maxRows = 0;
float springiness = 0.1;
int tileSize = 120;
...
static argtype vars[] = 
{
    ...
    {&borderColor, "borderColor", NULL, "blue", t_String},
    {&delay, "delay", NULL, "10000", t_Int},
    {&duration, "duration", NULL, "120", t_Int},
    {&eventChance, "eventChance", NULL, "0.01", t_Float},
    {&friction, "friction", NULL, "0.05", t_Float},
    {&maxColumns, "maxColumns", NULL, "9", t_Int},
    {&maxRows, "maxRows", NULL, "0", t_Int},
...
static void setup (struct state *st)
{
    ...
    gcv.foreground = load_color(st->dpy, xgwa.colormap, borderColor);
    ...
    gcv.foreground = load_color(st->dpy, xgwa.colormap, background);
    st->backgroundPixel = gcv.foreground;
    st->backgroundGC = XCreateGC (st->dpy, st->window, GCForeground, &gcv);

    //gcv.foreground = get_pixel_resource (st->dpy, xgwa.colormap,
    //                                     "foreground", "Foreground");
    gcv.foreground = load_color(st->dpy, xgwa.colormap, foreground);
