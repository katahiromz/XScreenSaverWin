...
static argtype vars[] = 
{
    ...
    {&width, "width", NULL, "0", t_Int},
    {&height, "height", NULL, "0", t_Int},
    {&epoch, "epoch", NULL, "40000", t_Int},
    {&reaction, "reaction", NULL, "-1", t_Int},
    {&diffusion, "diffusion", NULL, "-1", t_Int},
    {&radius, "radius", NULL, "-1", t_Int},
    {&speed, "speed", NULL, "0.0", t_Float},
    {&size, "size", NULL, "1.0", t_Float},
    {&delay, "delay", NULL, "30000", t_Int},
    {&colors, "colors", NULL, "255", t_Int},
};
