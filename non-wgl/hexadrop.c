...
static argtype vars[] = 
{
    ...
    {&sides, "sides", NULL, "0", t_Int},
    {&size_, "size", NULL, "15", t_Int},
    {&speed, "speed", NULL, "1.0", t_Float},
    {&ncolors, "ncolors", NULL, "128", t_Int},
    {&uniform, "uniform", NULL, "Maybe", t_String},
    {&lockstep, "lockstep", NULL, "Maybe", t_String},
};
