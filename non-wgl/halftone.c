...
static argtype vars[] = 
{
    ...
    {&count_, "count", NULL, "10", t_Int},
    {&minMass, "minMass", NULL, "0.001", t_Float},
    {&maxMass, "maxMass", NULL, "0.02", t_Float},
    {&minSpeed, "minSpeed", NULL, "0.001", t_Float},
    {&maxSpeed, "maxSpeed", NULL, "0.02", t_Float},
    {&spacing_, "spacing", NULL, "14", t_Int},
    {&sizeFactor, "sizeFactor", NULL, "1.5", t_Float},
    {&colors, "colors", NULL, "200", t_Int},
    {&cycleSpeed, "cycleSpeed", NULL, "10", t_Int},
};
