...
float xspeed = 1.0;
float yspeed = 1.0;
float xamplitude = 1.0;
float yamplitude = 1.0;
int whirlies = -1;
int nlines = -1;
char *xmode = "change";
char *ymode = "change";
...
static argtype vars[] = 
{
    ...
    {&xspeed, "xspeed", NULL, "1.0", t_Float},
    {&yspeed, "yspeed", NULL, "1.0", t_Float},
    {&xamplitude, "xamplitude", NULL, "1.0", t_Float},
    {&yamplitude, "yamplitude", NULL, "1.0", t_Float},
    {&whirlies, "whirlies", NULL, "-1", t_Int},
    {&nlines, "nlines", NULL, "-1", t_Int},
    {&xmode, "xmode", NULL, "change", t_String},
    {&ymode, "ymode", NULL, "change", t_String},
    {&speed, "speed", NULL, "1", t_Int},
    {&trail, "trail", NULL, "False", t_Bool},
    {&color_modifier, "color_modifier", NULL, "-1", t_Int},
    {&start_time, "start_time", NULL, "-1", t_Int},
    {&explain, "explain", NULL, "False", t_Bool},
    {&xoffset, "xoffset", NULL, "1.0", t_Float},
    {&yoffset, "yoffset", NULL, "1.0", t_Float},
    {&offset_period, "offset_period", NULL, "1", t_Int},
    {&wrap, "wrap", NULL, "False", t_Bool},
