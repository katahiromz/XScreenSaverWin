...
int ncolors = 100;
int delay = 10000;
float disorder = 0.005;
Bool cycle = False;
float handedness = 0.5;

static argtype vars[] = 
{
    {&background, "background", NULL, "black", t_String},
    {&foreground, "foreground", NULL, "white", t_String},
    {&fill, "fill", NULL, "75", t_Int},
    {&count, "count", NULL, "0", t_Int},
    {&ncolors, "ncolors", NULL, "100", t_Int},
    {&delay, "delay", NULL, "10000", t_Int},
    {&disorder, "disorder", NULL, "0.005", t_Float},
    {&cycle, "cycle", NULL, "False", t_Bool},
    {&handedness, "handedness", NULL, "0.5", t_Float},
};
  ...
  struct state *st = (struct state *) calloc (1, sizeof(*st));
   ...
   st->delay= delay;
    ...
    if( mono_p ) {
      ...
      st->colors[0].pixel=load_color(st->dpy, cmap, foreground);
    } else {
