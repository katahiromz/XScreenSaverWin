...
static argtype vars[] = 
{
    ...
    {&move, "move", NULL, "0.5", t_Float},
    {&wobble, "wobble", NULL, "2.0", t_Float},
    {&cycle, "cycle", NULL, "10.0", t_Float},
    {&mag, "mag", NULL, "1.0", t_Float},
    {&minutes, "minutes", NULL, "False", t_Bool},
    {&delay, "delay", NULL, "40000", t_Int},
    {&fast, "fast", NULL, "50", t_Int},
    {&colcycle, "colcycle", NULL, "False", t_Bool},
    {&hsvcycle, "hsvcycle", NULL, "0.0", t_Float},
    {&rgb, "rgb", NULL, "", t_String},
    {&hsv, "sleep", NULL, "", t_String},
};
