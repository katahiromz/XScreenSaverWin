...
static argtype vars[] = 
{
    ...
    {&speed_, "speed", NULL, "15", t_Int},
    {&ncolors, "ncolors", NULL, "256", t_Int},
    {&colorspeed, "colorspeed", NULL, "10", t_Int},
    {&count, "count", NULL, "32", t_Int},
    {&minradius_, "minradius", NULL, "0.05", t_Float},
    {&maxradius_, "maxradius", NULL, "0.2", t_Float},
