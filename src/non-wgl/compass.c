...
char *foreground = "#DDFFFF";
char *arrow1Foreground = "#FFF66A";
char *arrow2Foreground = "#F7D64A";
char *pointerForeground = "#FF0000";
int delay = 20000;
...
static argtype vars[] = 
{
    ...
    {&foreground, "foreground", NULL, "#DDFFFF", t_String},
    {&arrow1Foreground, "arrow1Foreground", NULL, "#FFF66A", t_String},
    {&arrow2Foreground, "arrow2Foreground", NULL, "#F7D64A", t_String},
    {&pointerForeground, "pointerForeground", NULL, "#FF0000", t_String},
...
# endif
  ...
  gcv.foreground = load_color(st->dpy, st->xgwa.colormap, arrow2Foreground);
  ...
  gcv.foreground = load_color(st->dpy, st->xgwa.colormap, arrow1Foreground);
  gcv.line_width = MAX(4, (st->size / 30));
  ...
  gcv.foreground = load_color(st->dpy, st->xgwa.colormap, pointerForeground);
