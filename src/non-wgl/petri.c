...
int size = 2;
float diaglim = 1.414;
float anychan = 0.0015;
float minorchan = 0.5;
float instantdeathchan = 0.2;
int minlifespan = 500;
int maxlifespan = 1500;
float minlifespeed = 0.04;
float maxlifespeed = 0.13;
float mindeathspeed = 0.42;
float maxdeathspeed = 0.46;
Bool originalcolors = False;
char *memThrottle = "22M";
...
static argtype vars[] = 
{
    ...
    {&count, "count", NULL, "20", t_Int},
    {&size, "size", NULL, "2", t_Int},
    {&diaglim, "diaglim", NULL, "1.414", t_Float},
    {&anychan, "anychan", NULL, "0.0015", t_Float},
    {&minorchan, "minorchan", NULL, "0.5", t_Float},
    {&instantdeathchan, "instantdeathchan", NULL, "0.2", t_Float},
    {&minlifespan, "minlifespan", NULL, "500", t_Int},
    {&maxlifespan, "maxlifespan", NULL, "1500", t_Int},
    {&minlifespeed, "minlifespeed", NULL, "0.04", t_Float},
    {&maxlifespeed, "maxlifespeed", NULL, "0.13", t_Float},
    {&mindeathspeed, "mindeathspeed", NULL, "0.42", t_Float},
    {&maxdeathspeed, "maxdeathspeed", NULL, "0.46", t_Float},
    {&originalcolors, "originalcolors", NULL, "False", t_Bool},
    {&memThrottle, "memThrottle", NULL, "22M", t_String},
};
...
setup_display (struct state *st)
{
    ...
    st->originalcolors = originalcolors;
    ...
    st->instantdeathchan = instantdeathchan;
    ...
    st->mindeathspeed = mindeathspeed;
    ...
    st->maxdeathspeed = maxdeathspeed;
