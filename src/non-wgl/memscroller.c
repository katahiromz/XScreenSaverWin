...
char *drawMode = "color";
char *filename = "(RAM)";
char *textColor = "#00FF00";
char *foreground = "#00FF00";
int borderSize = 2;
char *font1 = "OCRB 192, Lucida Console 192";
char *font2 = "OCRB 144, Lucida Console 144";
char *font3 = "OCRB 128, Lucida Console 128";
char *font4 = "OCRB 96, Lucida Console 96";
char *font5 = "OCRB 48, Lucida Console 48";
char *font6 = "OCRB 24, Lucida Console 24";
int delay = 10000;
int offset = 0;
...
static argtype vars[] = 
{
    ...
    {&drawMode, "drawMode", NULL, "color", t_String},
    {&filename, "filename", NULL, "(RAM)", t_String},
    {&textColor, "textColor", NULL, "#00FF00", t_String},
    {&foreground, "foreground", NULL, "#00FF00", t_String},
    {&borderSize, "borderSize", NULL, "2", t_Int},
    {&font1, "font1", NULL, "OCRB 192, Lucida Console 192", t_String},
    {&font2, "font2", NULL, "OCRB 144, Lucida Console 144", t_String},
    {&font3, "font3", NULL, "OCRB 128, Lucida Console 128", t_String},
    {&font4, "font4", NULL, "OCRB 96, Lucida Console 96", t_String},
    {&font5, "font5", NULL, "OCRB 48, Lucida Console 48", t_String},
    {&font6, "font6", NULL, "OCRB 24, Lucida Console 24", t_String},
    {&delay, "delay", NULL, "10000", t_Int},
    {&offset, "offset", NULL, "0", t_Int},
};
    ...
    for (i = nfonts-1; i >= 0; i--)
      {
        ...
        switch(i)
        {
        case 0: fontname = font1;
        case 1: fontname = font2;
        case 2: fontname = font3;
        case 3: fontname = font4;
        case 4: fontname = font5;
        case 5: fontname = font6;
        }
...
#if 1
  gcv.background = load_color(st->dpy, st->xgwa.colormap, background);
  gcv.foreground = load_color(st->dpy, st->xgwa.colormap, textColor);
#else
...
#if 1
  gcv.foreground = load_color(st->dpy, st->xgwa.colormap, foreground);
#else
  gcv.foreground = get_pixel_resource(st->dpy, st->xgwa.colormap,
...
#if 1
      if (!sc->image)
        sc->image = XCreateImage (st->dpy, st->xgwa.visual, 32,
                                  RGBAPixmap_, 0, 0, 1, max_height, 8, 0);
#else
      if (!sc->image)
