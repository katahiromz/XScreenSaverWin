...
static argtype vars[] = 
{
    ...
    {&drawDelay, "drawDelay", NULL, "30000", t_Int},
    {&numDiscs, "numDiscs", NULL, "85", t_Int},
    {&maxRiders, "maxRiders", NULL, "40", t_Int},
    {&maxRadius, "maxRadius", NULL, "100", t_Int},
    {&colors, "colors", NULL, "256", t_Int},
};
...
intermomentary_init (Display *dpy, Window window)
{
  struct state *st = (struct state *) calloc (1, sizeof(*st));
    ...
    gcv.background = load_color(dpy, st->xgwa.colormap, background);
#else
...
#if 1
    st->draw_delay = drawDelay;
    st->f->maxrider = maxRiders;
    st->f->maxradius = maxRadius;
    st->f->initial_discs = numDiscs;
#else
