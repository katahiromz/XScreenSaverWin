...
static Bool martin = False;
static Bool popcorn = False;
static Bool ejk1 = False;
static Bool ejk2 = False;
static Bool ejk3 = False;
static Bool ejk4 = False;
static Bool ejk5 = False;
static Bool ejk6 = False;
static Bool rr = False;
static Bool jong = False;
