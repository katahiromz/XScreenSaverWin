...
int maxCycles = 10000;
int growthDelay = 18000;
int initialCracks = 3;
int maxCracks = 100;
int sandGrains = 64;
int circlePercent = 33;

static argtype vars[] = 
{
    {&background, "background", NULL, "white", t_String},
    {&foreground, "foreground", NULL, "black", t_String},
    {&wireFrame, "wireFrame", NULL, "False", t_Bool},
    {&maxCycles, "maxCycles", NULL, "10000", t_Int},
    {&growthDelay, "growthDelay", NULL, "18000", t_Int},
    {&initialCracks, "initialCracks", NULL, "3", t_Int},
    {&maxCracks, "maxCracks", NULL, "100", t_Int},
    {&sandGrains, "sandGrains", NULL, "64", t_Int},
    {&circlePercent, "circlePercent", NULL, "33", t_Int},
};
...
substrate_init (Display *dpy, Window window)
{
    ...
    st->f->initial_cracks = initialCracks;
    st->f->max_num = maxCracks;
    st->f->wireframe = wireFrame;
    st->f->grains = sandGrains;
    st->f->circle_percent = circlePercent;
#else
