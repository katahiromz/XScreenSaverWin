...
static GLfloat blend = 1.0;
static Bool wireframe = False;
static Bool do_fog = False;
static Bool do_antialias = False;
static Bool do_walls = False;
static Bool do_texture = True;
static Bool do_paint_background = True;
static Bool do_colour = False;
static Bool offset_texture = False;
static int resolution = 30;
static int bumps = 10;
static float motion_blur = 0.0;
static float fade_time = 5.0;
static float hold_time = 30.0;
