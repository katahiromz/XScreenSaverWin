...
static int do_which;
static char *do_which_str = "random";

char *titleFont = "Arial 30";
char *titleFont2 = "Arial 20";
char *titleFont3 = "Arial 10";
...
static argtype vars[] = {
  ...
  {&do_which_str,"which", "Which", DEF_WHICH,   t_String},
	...
	{&titleFont2, "titleFont2", NULL, "Arial 20", t_String},
	{&titleFont3, "titleFont3", NULL, "Arial 10", t_String},
};
...
# ifdef HAVE_TESS
  ...
  gluTessCallback (tobj, GLU_TESS_ERROR,  &tess_error);
# endif /* HAVE_TESS */
...
construct_teapot (ModeInfo *mi)
{
  ...
  p->number = n;
  p->wythoff = _strdup("X00398|1984");
  p->name = _strdup("Teapot");
  p->dual = _strdup("");
  p->config = _strdup("Melitta");
  p->group = _strdup("Teapotahedral (Newell[1975])");
  p->class = _strdup("Utah Teapotahedron");
  bp->polyhedra[n] = p;
}
