...
static char *do_spin = "Z";
static char *do_style = "random";
static GLfloat speed = 0.003;
static Bool do_wander = False;
static int resolution = 40;
static Bool do_smooth = True;
static Bool do_impatient = False;

static char *lava_color_str = "#FF0000", *fluid_color_str = "#00AAFF", *base_color_str = "#666666",
  *table_color_str = "#000000";
static char *fluid_tex = "(none)", *base_tex = "(none)", *table_tex = "(none)";
