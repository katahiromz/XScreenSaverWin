...
static Bool doGasket = True;
static Bool doHelix = True;
static Bool doLadder = True;
static Bool doFrame = True;
static int wallFacets = 360;
static int barFacets = 90;
static Bool clockwise = False;
static float turns = 0.69;
static float turnSpacing = 2.2;
static float barSpacing = 0.24;
static float wallHeight = 0.45;
static float wallThickness = 0.12;
static float barThickness = 0.058;
static float wallTaper = 0.95;
static float gasketSize = 1.88;
static float gasketDepth = 0.15;
static float gasketThickness = 0.4;
static float frameSize = 1.20;
static float frameDepth = 0.01;
static float frameThickness = 0.03;
static float triangleSize = 0.045;
...
init_logo (ModeInfo *mi)
{
  ...
  int do_gasket = doGasket;
  int do_helix = doHelix;
  int do_ladder = (do_helix && doLadder);
  int do_frame = doFrame;
  ...
  dc->wall_facets    = wallFacets;
  dc->bar_facets     = barFacets;
  dc->clockwise      = clockwise;
  dc->turns          = turns;
  dc->turn_spacing   = turnSpacing;
  dc->bar_spacing    = barSpacing;
  dc->wall_height    = wallHeight;
  dc->wall_thickness = wallThickness;
  dc->bar_thickness  = barThickness;
  dc->wall_taper     = wallTaper;
  
  dc->gasket_size      = gasketSize;
  dc->gasket_depth     = gasketDepth;
  dc->gasket_thickness = gasketThickness;
  
  dc->frame_size      = frameSize;
  dc->frame_depth     = frameDepth;
  dc->frame_thickness = frameThickness;
  dc->triangle_size   = triangleSize;
...

  {
    ...
    char *color_name = _strdup(foreground);
    char *s2;
