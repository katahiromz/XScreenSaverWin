...
static GLfloat complexity_arg = 1.0;
static int resolution_arg = 100;
static GLfloat thickness_arg = 0.06;
...
#  endif
      ...
      gluTessCallback(tess, GLU_TESS_VERTEX_DATA,(void (__stdcall *)())tess_vertex_cb);
      gluTessCallback(tess, GLU_TESS_END,        (void (__stdcall *)())glEnd);
      gluTessCallback(tess, GLU_TESS_COMBINE,    (void (__stdcall *)())tess_combine_cb);
      gluTessCallback(tess, GLU_TESS_ERROR,      (void (__stdcall *)())tess_error_cb);
