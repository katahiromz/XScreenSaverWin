...
static int num_quads = 5;
static int do_light = False;
static int do_wire = False;
static int do_blend = True;
static int do_fog = False;
static int do_antialias = False;
static int do_texture = False;
static int do_texture_quality = False;
static int do_mipmap = False;
