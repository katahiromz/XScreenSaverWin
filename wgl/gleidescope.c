...
/* they can't be, because of the idiotic way the xlockmore "argtype vars"
   interface works. -jwz */
#ifdef GRAB
static Bool		grab = False;			/* grab images */
#endif
static Bool		move = False;			/* moving camera */
static Bool		nomove = False;			/* no moving camera */
static Bool		rotate = False;			/* rotate in place */
static Bool		norotate = False;		/* no rotate in place */
static Bool		zoom = False;			/* zooming camera */
static Bool		nozoom = False;			/* no zooming camera */
