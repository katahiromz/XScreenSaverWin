...
static GLfloat arg_speed = 1.0;
static int smooth_p = True;
static int texture_p = True;
static int cel_p = False;
static int intersect_p = False;
static int arg_slices = 16;
static int arg_segments = 24;
static GLfloat arg_thickness = 1.0;
static GLfloat arg_length = 9.0;
static GLfloat arg_wiggliness = 0.35;
static GLfloat arg_flexibility = 0.35;
static char *arg_color = "#305A30", *arg_stripe = "#451A30", *arg_sucker = "#453E30";
