...
static char *text_fmt = "(default)";
char *program = "(default)";
static char *do_spin = "XYZ";
static Bool do_wander = True;
static Bool face_front_p = True;
...
static argtype vars[] = {
  ...
  {&face_front_p, "faceFront", "FaceFront", DEF_FACE_FRONT, t_Bool},
    ...
    {&relaunchDelay, "relaunchDelay", NULL, "0", t_Int},	//
};
...
# else	/* !HAVE_UNAME */
#  ifdef VMS
      tp->text = _strdup(getenv("SYS$NODE"));
#  else
      tp->text = _strdup("*  *\n*  *  *\nxscreensaver\n*  *  *\n*  *");
#  endif
# endif	/* !HAVE_UNAME */
