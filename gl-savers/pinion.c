...
static GLfloat spin_speed = 1.0, scroll_speed = 1.0, gear_size = 1.0, max_rpm = 900;
...
char *titleFont = "Arial 40";
char *titleFont2 = "Arial 30";
char *titleFont3 = "Arial 20";
...
static argtype vars[] = {
  ...
  {&verbose_p,    "verbose",     "Verbose",     "False",          t_Bool},
    {&titleFont, "titleFont", NULL, "Arial 40", t_String},
    {&titleFont2, "titleFont2", NULL, "Arial 30", t_String},
    {&titleFont3, "titleFont3", NULL, "Arial 20", t_String},
};
