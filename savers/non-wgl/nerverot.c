...
float minRadius = 3;
int maxRadius = 25;
float maxNerveRadius = 0.7;
float nervousness = 0.3;

static argtype vars[] = 
{
    {&background, "background", NULL, "black", t_String},
    {&foreground, "foreground", NULL, "white", t_String},
    {&count, "count", NULL, "250", t_Int},
    {&colors, "colors", NULL, "4", t_Int},
    {&delay, "delay", NULL, "10000", t_Int},
    {&maxIters, "maxIters", NULL, "1200", t_Int},
    {&doubleBuffer, "doubleBuffer", NULL, "False", t_Bool},
    {&eventChance, "eventChance", NULL, "0.2", t_Float},
    {&iterAmt, "iterAmt", NULL, "0.01", t_Float},
    {&lineWidth, "lineWidth", NULL, "0", t_Int},
    {&minScale, "minScale", NULL, "0.6", t_Float},
    {&maxScale, "maxScale", NULL, "1.75", t_Float},
    {&minRadius, "minRadius", NULL, "3.0", t_Float},
    {&maxRadius, "maxRadius", NULL, "25", t_Int},
    {&maxNerveRadius, "maxNerveRadius", NULL, "0.7", t_Float},
    {&nervousness, "nervousness", NULL, "0.3", t_Float},
};
...
# endif
    ...
    st->maxNerveRadius = maxNerveRadius;
