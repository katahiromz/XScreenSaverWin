...
static argtype vars[] = 
{
    ...
    {&bitmapBaseline, "bitmapBaseline", NULL, "20", t_Int},
    {&delay, "delay", NULL, "10000", t_Int},
    {&hspread, "hspread", NULL, "30", t_Int},
    {&vspread, "vspread", NULL, "97", t_Int},
    {&residual, "residual", NULL, "99", t_Int},
    {&variance, "variance", NULL, "50", t_Int},
    {&vartrend, "vartrend", NULL, "20", t_Int},
    {&bloom, "bloom", NULL, "True", t_Bool},
};
...
InitFlame(struct state *st)
{
  ...
  st->ihspread  = hspread;
  st->ivspread  = vspread;
  st->iresidual = residual;
  st->variance  = variance;
  st->vartrend  = vartrend;
  st->bloom     = bloom;
#else
