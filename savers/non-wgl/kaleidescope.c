...
char *color_mode = "nice";
int symmetry = 11;
int ntrails = 100;
int nsegments = 7;
int narcs = 0;
int local_rotation = -59;
...
static argtype vars[] = 
{
    ...
    {&color_mode, "color_mode", NULL, "nice", t_String},
    {&symmetry, "symmetry", NULL, "11", t_Int},
    {&ntrails, "ntrails", NULL, "100", t_Int},
    {&nsegments, "nsegments", NULL, "7", t_Int},
    {&narcs, "narcs", NULL, "0", t_Int},
    {&local_rotation, "local_rotation", NULL, "-59", t_Int},
    {&global_rotation, "global_rotation", NULL, "1", t_Int},
    {&spring_constant, "spring_constant", NULL, "5", t_Int},
    {&delay, "delay", NULL, "20000", t_Int},
    {&redmin, "redmin", NULL, "30000", t_Int},
    {&redrange, "redrange", NULL, "20000", t_Int},
    {&greenmin, "greenmin", NULL, "30000", t_Int},
    {&greenrange, "greenrange", NULL, "20000", t_Int},
    {&bluemin, "bluemin", NULL, "30000", t_Int},
    {&bluerange, "bluerange", NULL, "20000", t_Int},
};
...
init_g (GLOBAL *g)
{
  ...
  g->symmetry        = symmetry;
  g->ntrails         = ntrails;
  g->nsegments       = nsegments;
  g->narcs           = narcs;
  g->local_rotation  = local_rotation;
  g->global_rotation = global_rotation;
  g->spring_constant = spring_constant;
  g->delay           = delay;
  g->nobjects        = g->nsegments + g->narcs;

  color_mode_str = _strdup(color_mode);
#else
  ...
  g->redrange   = redrange;
  g->greenmin   = greenmin;
  g->greenrange = greenrange;
  g->bluemin    = bluemin;
  g->bluerange  = bluerange;
#else
  ...
  gcv.foreground = g->default_fg_pixel = load_color(g->dpy, g->cmap, foreground);
  ...
  gcv.foreground = load_color(g->dpy, g->cmap, background);
