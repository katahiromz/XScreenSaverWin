...
int solveDelay = 10000;
int preDelay = 2000000;
int postDelay = 4000000;

char *liveColor = "#00FF00";
char *deadColor = "#880000";
char *skipColor = "#8B5A00";
char *surroundColor = "#220055";

static argtype vars[] = 
{
    {&background, "background", NULL, "black", t_String},
    {&foreground, "foreground", NULL, "white", t_String},
    {&gridSize, "gridSize", NULL, "0", t_Int},
    {&generator_, "generator", NULL, "-1", t_Int},
    {&maxLength, "maxLength", NULL, "5", t_Int},
    {&ignorant, "ignorant", NULL, "False", t_Bool},
    {&solveDelay, "solveDelay", NULL, "10000", t_Int},
    {&preDelay, "preDelay", NULL, "2000000", t_Int},
    {&postDelay, "postDelay", NULL, "4000000", t_Int},
    {&liveColor, "liveColor", NULL, "#00FF00", t_String},
    {&deadColor, "deadColor", NULL, "#880000", t_String},
    {&skipColor, "skipColor", NULL, "#8B5A00", t_String},
    {&surroundColor, "surroundColor", NULL, "#220055", t_String},
};
...
#if 1
  size = gridSize;
  st->solve_delay = solveDelay;
  st->pre_solve_delay = preDelay;
  st->post_solve_delay = postDelay;
  generator = generator_;
  st->max_length = maxLength;
  st->ignorant_p = ignorant;
#else
...
#if 1
  bg  = load_color(st->dpy, xgwa.colormap, background);
  fg  = load_color(st->dpy, xgwa.colormap, foreground);
  pfg = load_color(st->dpy, xgwa.colormap, liveColor);
  pbg = load_color(st->dpy, xgwa.colormap, deadColor);
  sfg = load_color(st->dpy, xgwa.colormap, skipColor);
  ufg = load_color(st->dpy, xgwa.colormap, surroundColor);
#else
