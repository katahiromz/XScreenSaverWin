...
char *foreground = "#CCCCCC";
char *textForeground = "black";
char *textBackground = "#CCCCCC";
//char *program = "xscreensaver-text --cols 40 | head -n15";
char *program = "xscreensaver-text --cols 40 --head 15";
char *font = "Century 25";
...
static argtype vars[] = 
{
    ...
    {&foreground, "foreground", NULL, "#CCCCCC", t_String},
    {&textForeground, "textForeground", NULL, "black", t_String},
    {&textBackground, "textBackground", NULL, "#CCCCCC", t_String},
    {&font, "font", NULL, "Century 50", t_String},
    {&program, "textProgram", NULL, "xscreensaver-text --cols 40 --head 15", t_String},
...
#if 1
  fg = load_color(st->dpy, cmap, foreground);
  bg = load_color(st->dpy, cmap, background);
  text_fg = load_color(st->dpy, cmap, textForeground);
  text_bg = load_color(st->dpy, cmap, textBackground);
#else
