...
static argtype vars[] = 
{
    ...
    {&count, "count", NULL, "3", t_Int},
    {&gridsize, "gridsize", NULL, "4", t_Int},
    {&ncolors, "ncolors", NULL, "128", t_Int},
    {&hue, "hue", NULL, "0", t_Int},
    {&speed, "speed", NULL, "30", t_Int},
    {&delay, "delay", NULL, "30000", t_Int},
    {&color_shift, "color_shift", NULL, "60.0", t_Float},
    {&radius_, "radius", NULL, "800", t_Int},
    {&gray_, "gray", NULL, "False", t_Bool},
    {&mono_, "mono", NULL, "False", t_Bool},
