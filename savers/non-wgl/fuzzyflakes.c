...
static argtype vars[] = 
{
    {&color, "color", NULL, "3", t_String},
    {&arms, "arms", NULL, "5", t_Int},
    {&thickness, "thickness", NULL, "10", t_Int},
    {&bthickness, "bthickness", NULL, "3", t_Int},
    {&radius, "radius", NULL, "20", t_Int},
    {&layers, "layers", NULL, "3", t_Int},
    {&density, "density", NULL, "5", t_Int},
    {&fallingspeed, "fallingspeed", NULL, "10", t_Int},
    {&delay, "delay", NULL, "10000", t_Int},
    {&doubleBuffer, "doubleBuffer", NULL, "True", t_Bool},
    {&randomColors, "randomColors", NULL, "False", t_Bool},
};
...
#if 1
   flake->Arms = arms;
   flake->Thickness = thickness;
   flake->BorderThickness = bthickness;
   flake->Radius = radius;
#else
...
#if 1
   flake->Density = density;
   flake->Layers = layers;
   flake->FallingSpeed = fallingspeed;
   flake->Delay = delay;
   if (flake->RandomColors == True)
      flake->RandomColors = randomColors;
#else
