...
static argtype vars[] = 
{
    ...
    {&delay, "delay", NULL, "500000", t_Int},
    {&colors, "colors", NULL, "128", t_Int},
    {&iterations, "iterations", NULL, "100", t_Int},
    {&shadowWidth, "shadowWidth", NULL, "2", t_Int},
    {&elevation, "elevation", NULL, "5", t_Int},
    {&sway, "sway", NULL, "30", t_Int},
    {&tweak, "tweak", NULL, "20", t_Int},
    {&gridSize, "gridSize", NULL, "12", t_Int},
};
...
#if 1
  st->bg_pixel = load_color(st->dpy, st->xgwa.colormap, background);
  st->fg_pixel = load_color(st->dpy, st->xgwa.colormap, foreground);
#else
