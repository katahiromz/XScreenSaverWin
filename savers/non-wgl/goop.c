...
static argtype vars[] = 
{
    ...
    {&delay, "delay", NULL, "12000", t_Int},
    {&additive, "additive", NULL, "True", t_Bool},
    {&mode, "mode", NULL, "transparent", t_String},
    {&count, "count", NULL, "1", t_Int},
    {&planes, "planes", NULL, "12", t_Int},
    {&thickness, "thickness", NULL, "5", t_Int},
    {&torque, "torque", NULL, "0.0075", t_Float},
    {&elasticity, "elasticity", NULL, "0.9", t_Float},
    {&maxVelocity, "maxVelocity", NULL, "0.5", t_Float},
};
...
#if 1
  b->torque       = torque;
  b->elasticity   = SCALE * elasticity;
  b->max_velocity = SCALE * maxVelocity;
#else
...
#if 1
      goop->background = load_color(dpy,cmap, background);
#else
      goop->background =
