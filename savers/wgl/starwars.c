...
char *program = "xscreensaver-text --cols 0";
static int max_lines = 125;
static int scroll_steps = 35;
static float star_spin = 0.03;
static float font_size = -1;
static int target_columns = -1;
static int wrap_p = True;
static int smooth_p = True;
static int thick_p = True;
static int fade_p = True;
static int textures_p = True;
static int debug_p = False;
static char *alignment_str = "Center";
...
static argtype vars[] = {
  ...
  {&textMode, "textMode", NULL, "file", t_String},
  {&textLiteral, "textLiteral", NULL, DEF_TEXT, t_String},
  {&textFile, "textFile", NULL, "starwars.txt", t_String},
